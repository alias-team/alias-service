...
export function EditorialHeader({ cover }: EditorialHeaderProps) {
  return (
    <header data-editorial-component="EditorialHeader">
      <table role="presentation" width="100%" cellPadding="0" cellSpacing="0"><tbody><tr>
        <td style={{ padding: "64px 96px 52px" }}>
          ...
          <h1 style={{ color: colors.ink, fontFamily: fonts.display, fontSize: "96px", fontWeight: 700, letterSpacing: "-0.035em", lineHeight: 0.94, margin: "0 0 32px", maxWidth: "1080px" }}>{cover.title}</h1>
          <p style={{ color: colors.body, fontFamily: fonts.editorial, fontSize: "22px", fontWeight: 400, letterSpacing: "0.005em", lineHeight: 1.6, margin: 0, maxWidth: "100%", whiteSpace: "nowrap" }}>{cover.hero_message}</p>
        </td>
      </tr></tbody></table>
    </header>
  );
