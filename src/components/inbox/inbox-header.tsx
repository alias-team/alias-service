...
export function InboxHeader() {
  return (
    <header
      ...
      className="flex h-16 shrink-0 items-center gap-5 bg-[#F8FAFC] px-4"
    >
      <div className="flex w-[200px] shrink-0 items-center gap-5">
        ...
        <div className="flex items-center gap-2.5" aria-label="Gmail">
          <Image
      ...
      <div className="flex min-w-0 flex-1 items-center gap-5 pl-9">
        <label className="relative mr-auto flex h-[46px] max-w-[720px] flex-1 items-center rounded-lg bg-[#eef1f6] transition-shadow focus-within:bg-white focus-within:shadow-[0_1px_3px_1px_rgba(60,64,67,0.15)]">
